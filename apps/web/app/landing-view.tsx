...
// ── STATIC FIXTURE: leaderboard / fills / contests ────────────────────────
const LEADERS = [
...
export function LandingView() {
  ...
  return (
    <div className="layout">
      {/* Shared <LeftRail/> — same component used on /trade. Landing page
          adds the Filter matrix section; trade page omits it. */}
      <LeftRail showFilters />
